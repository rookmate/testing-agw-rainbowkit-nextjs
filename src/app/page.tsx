...
const BackgroundEffects = () => (
  <>
    ...
    <div className="absolute top-0 left-0 right-0 h-[70vh] bg-gradient-to-b from-[#00ff00] to-transparent opacity-15 blur-[100px]" />
    <div className="absolute bottom-0 right-0 w-1/2 h-1/2 bg-gradient-to-tl from-[#00ff00] to-transparent opacity-10 blur-3xl" />
  </>
);
...
const WalletConnection = ({ address, logout, writeContractSponsored, transactionReceipt }) => (
  <div className="bg-white/5 border border-white/10 rounded-lg p-6 shadow-lg backdrop-blur-sm max-w-sm w-full">
    <div className="flex flex-col items-center gap-4">
      ...
      <WalletActions logout={logout} writeContractSponsored={writeContractSponsored} address={address} />
...
const WalletActions = ({ logout, writeContractSponsored, address }) => (
...
const SubmitTransactionButton = ({ writeContractSponsored, address }) => (
  <button
